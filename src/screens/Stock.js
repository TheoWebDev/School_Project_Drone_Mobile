  ...
  return (
    <>
      <View style={styles.container}>
        <Text style={styles.titleSky}>
          SKY <Text style={styles.titleBlack}>DR</Text>O
          <Text style={styles.titleBlack}>NE</Text>
        </Text>
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              ...
              <Text style={styles.textStateModal}>
                Statut :{" "}
                <Text
                  style={
                    checkIfTempState(modalData.state) == "En Stock"
                      ? styles.textStateDrone
                      : styles.textStateDroneUnavailable &&
                        modalData.state == "En Location"
                      ? styles.textStateDroneResa
                      : styles.textStateDroneUnavailable
                  }
                >
                  {checkIfTempState(modalData.state)}
                </Text>
              </Text>
              ...
              >
                <Text style={styles.textStyleClose}>FERMER</Text>
              </Pressable>
            </View>
          </View>
        </Modal>
        <FlatList
          ...
          renderItem={({ item, index }) => (
            <View style={styles.card}>
              <Pressable onPress={() => setModal(item, index)}>
